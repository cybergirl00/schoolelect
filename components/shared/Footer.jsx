const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <div className="">
        <h3 className="text-4xl font-bold">School<span className='text-primary'>Elect</span></h3>
      </div>
    </div>
    ...
    <p className="text-xs text-gray-500">&copy; 2024. SchoolElect. All rights reserved.</p>
  </div>
</footer>
  )
}
